...
// _indvecqk contains the positions of vettoreqk according to the previous order
  ...
  //set the following for the dependence
    //locdep(0,0)=4;
    //locdep(0,1)=5;
...
//boost::mt19937 generator2(1234);
                        ...
                        for (int l = 0; l < _L; l++) {
                            for (int h = 0; h < _H; h++) {
                                for (int r = 0; r < _R; r++) {
                                    for (int j = 0; j < _n; j++) {
                                        if (_dephr[i] == 3) {
                                            if (y2(j, i + 3) == c && _B(j, h, r) == 1) {
                                                _num5(i, c, l, h, r) += _Prob3(j, l);
                                            }
                                        } else if (_dephr[i] == 2) {
                                            if (y2(j, i + 3) == c && _zjq(j, r) == 1) {
                                                _num5(i, c, l, h, r) += _Prob3(j, l);
                                            }
                                        } else if (_dephr[i] == 1) {
                                            if (y2(j, i + 3) == c && _wjk(j, h) == 1) {
                                                _num5(i, c, l, h, r) += _Prob3(j, l);
                                            }
                                        } else if (_dephr[i] == 0) {
                                            if (y2(j, i + 3) == c) {
            ...
            if (nlocdep > 0) {
                ...
                for (int d = 0; d < nlocdep; d++) {
                    ...
                    for (int l = 0; l < _L; l++) {
                        for (int j = 0; j < _n; j++) {
                            nyx1(y(j, locdep(d, 0) + 2), l) += _Prob4lvar(j, l);
                            //nyx1(y(j, locdep(d, 0) + 2), l) += _Prob4l(j, l);
                        }
                    }
                    ...
                    for (int l = 0; l < _L; l++) {
                        for (int j = 0; j < _n; j++) {
                            nyx2(y(j, locdep(d, 1) + 2), l) += _Prob4lvar(j, l);
                            //nyx2(y(j, locdep(d, 1) + 2), l) += _Prob4l(j, l);
                        }
                    }
                    ...
                    for (int c = 0; c < _vC[locdep(d, 0) - 1]; c++) {
                        for (int cc = 0; cc < _vC[locdep(d, 1) - 1]; cc++) {
                            for (int l = 0; l < _L; l++) {
                                for (int h = 0; h < _H; h++) {
                                    for (int r = 0; r < _R; r++) {
                                        _p(d, ar, l, h, r) = (double) myx(c, cc, l) / nx[l];
                                    }
                                }
                            }
                            ar = ar + 1;
            ...
            if (u1 == _iter - 1) {
                ...
                for (int h = 0; h < _H; h++) {
                    _p_hcc_hat[h] = (double) _p_hc_hat[h];
                }
    ...
    for (int c = 0; c < _C; c++) {
        for (int l = 0; l < _L; l++) {
            cout<<_p_hat(indicestarting,0, c, l, 0, 0)<<",";
        }
        cout<<"\n";
    }
    cout<<"\n";
    ...
    for (int c = 0; c < _C; c++) {
        for (int l = 0; l < _L; l++) {
            cout<<_p_hat(indicestarting,1, c, l, 0, 0)<<",";
        }
        cout<<"\n";
    }
    cout<<"\n";
    ...
    for (int c = 0; c < _C; c++) {
        for (int l = 0; l < _L; l++) {
            cout<<_p_hat(indicestarting,2, c, l, 0, 0)<<",";
        }
        cout<<"\n";
    }
    cout<<"\n";
    ...
    for (int c = 0; c < _C; c++) {
        for (int l = 0; l < _L; l++) {
            cout<<_p_hat(indicestarting,3, c, l, 0, 0)<<",";
        }
        cout<<"\n";
    }
    cout<<"\n";
